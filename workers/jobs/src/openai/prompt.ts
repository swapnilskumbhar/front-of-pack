...
export function buildTerraInstructions(
  ...
  return [
    ...
    "Web search is for analysis, never identity narration. Convert matched source content into at most two concrete consumer consequences: allergen/diet implications, claim support/contradiction, or exact whole-pack nutrition.",
    ...
    "wholeImageSummary, strongestMaterialFinding, and each product summary must each be at most 12 words. Do not repeat the same fact across them.",
    "Return at most two findings per product. Include only facts that could change a shopper's decision. Titles are at most 4 words; explanations at most 14 words.",
    ...
    "Write punchy fragments, not descriptive prose. The result must answer: should the shopper care, and why?",
