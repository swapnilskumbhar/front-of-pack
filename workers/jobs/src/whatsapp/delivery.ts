...
const FAILURE_COPY: Record<string, string> = {
  en: "We couldn't complete the analysis this time. Please resend the same image in a moment.",
  hi: "इस बार विश्लेषण पूरा नहीं हो सका। कृपया कुछ देर बाद वही तस्वीर दोबारा भेजें।",
  mr: "यावेळी विश्लेषण पूर्ण होऊ शकले नाही. कृपया थोड्या वेळाने तोच फोटो पुन्हा पाठवा.",
  bn: "এবার বিশ্লেষণ সম্পূর্ণ করা যায়নি। অনুগ্রহ করে কিছুক্ষণ পর একই ছবিটি আবার পাঠান।",
  ta: "இந்த முறை பகுப்பாய்வை முடிக்க முடியவில்லை. சிறிது நேரம் கழித்து அதே படத்தை மீண்டும் அனுப்பவும்.",
  te: "ఈసారి విశ్లేషణను పూర్తి చేయలేకపోయాం. దయచేసి కొద్దిసేపటి తర్వాత అదే చిత్రాన్ని మళ్లీ పంపండి.",
  kn: "ಈ ಬಾರಿ ವಿಶ್ಲೇಷಣೆಯನ್ನು ಪೂರ್ಣಗೊಳಿಸಲಾಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು ಸ್ವಲ್ಪ ಸಮಯದ ನಂತರ ಅದೇ ಚಿತ್ರವನ್ನು ಮತ್ತೆ ಕಳುಹಿಸಿ.",
  gu: "આ વખતે વિશ્લેષણ પૂર્ણ થઈ શક્યું નથી. કૃપા કરીને થોડી વાર પછી એ જ તસવીર ફરી મોકલો.",
  ml: "ഇത്തവണ വിശകലനം പൂർത്തിയാക്കാനായില്ല. കുറച്ച് കഴിഞ്ഞ് അതേ ചിത്രം വീണ്ടും അയയ്ക്കുക.",
  pa: "ਇਸ ਵਾਰ ਵਿਸ਼ਲੇਸ਼ਣ ਪੂਰਾ ਨਹੀਂ ਹੋ ਸਕਿਆ। ਕਿਰਪਾ ਕਰਕੇ ਕੁਝ ਸਮੇਂ ਬਾਅਦ ਉਹੀ ਤਸਵੀਰ ਦੁਬਾਰਾ ਭੇਜੋ।",
  or: "ଏଥର ବିଶ୍ଳେଷଣ ସମ୍ପୂର୍ଣ୍ଣ ହୋଇପାରିଲା ନାହିଁ। ଦୟାକରି କିଛି ସମୟ ପରେ ସେହି ଛବିଟି ପୁଣି ପଠାନ୍ତୁ।",
  ur: "اس بار تجزیہ مکمل نہیں ہو سکا۔ براہ کرم کچھ دیر بعد یہی تصویر دوبارہ بھیجیں۔",
};
