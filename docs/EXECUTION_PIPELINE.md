...
Current verification snapshot (2026-08-24): production proves public TLS, R2/D1/Queues/Jobs/Terra, cache hits, hosted search and live WhatsApp delivery. Prompt v9 records web-match confidence and turns sufficiently matched web content into cited provisional consequences instead of returning a decorative match. Decision-engine v3 supplies whole-container nutrition, claim, diet and allergen synthesis plus four consumer states: needs attention, some caution, no major concern found, or not enough information. Missing panels are not warnings, and green never means universally safe. Web and WhatsApp render the same compact indicator/profile/confidence hierarchy with full evidence retained behind the primary answer. Migration 0004 persists engine version. Real Haldiram and English Oven demos include photographs; the cart fixture remains synthetic. Personalised dietary profiles, delivery callbacks, a real six-product fixture, custom domain and submission artifacts remain.
