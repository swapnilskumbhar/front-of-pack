...
Current verification snapshot (2026-08-24): production proves public TLS, R2/D1/Queues/Jobs/Terra, cache hits, hosted search and live WhatsApp delivery. Prompt v8 adds printed veg-mark transcription to structured nutrition, claims and package-only ingredient tokens. Decision-engine v2 supplies whole-pack serving reality, realistic British/American sulphate matching, explicit dietary-origin signals, source-unclear additives, Jain preference information and FSSAI allergens. Web and WhatsApp render a deterministic verdict, up to two signals, four-check strip and identity confidence from the same stored result. Migration 0004 persists the engine version and cache identity includes it. `/how-we-decide` publishes claim and ingredient tables. Real Haldiram and English Oven demos include photographs; the cart fixture remains explicitly synthetic. Personalised dietary profiles, actual delivery callbacks, a real six-product fixture, custom domain and submission artifacts remain.
